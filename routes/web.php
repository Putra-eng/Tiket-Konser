...
Route::get('/admin/pemesanan', [PemesananController::class, 'indexAdmin'])->name('admin.pemesanan.index');
...
Route::get('/pembayaran/{id}', [PemesananController::class, 'show'])->name('pembayaran');
